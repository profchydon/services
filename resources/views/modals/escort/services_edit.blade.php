<div class="modal fade" id="services-update" tabindex="-1" role="dialog" aria-labelledby="signupLabel">
    ...
    <div class="modal-dialog  modal-lg" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                <h4 style="color:#fff; text-align:center;">You are updating the services you offer.</h4>
            ...
            <form class="form" action="service-update" method="post" id="service-update-form">
                {{ csrf_field() }}
